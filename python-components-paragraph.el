...
(defun py--fill-docstring-base (thisbeg thisend style multi-line-p first-line-p beg end py-current-indent orig)
  ;; (widen)
...
(defun py--fill-docstring-last-line (thisbeg thisend beg end style orig first-line-p)
  (widen)
  ;; (narrow-to-region thisbeg thisend)
  (goto-char thisend)
  (skip-chars-backward "\"'")
  ...
  (let* ((thisbeg (copy-marker docstring))
    ...
    (cond ((string-match (concat "^" py-labelled-re) (buffer-substring-no-properties beg end))
          ...
          ((save-excursion (goto-char end)
           ...
           (py--fill-docstring-last-line thisbeg thisend beg end style orig first-line-p))
