...
(defun py-dump-help-string (str)
  (with-output-to-temp-buffer "*Help*"
    (let ((locals (buffer-local-variables))
      ...
      (and comint-vars-p (py--princ-comint-variable-setting-intern)))
...
(defun py--princ-comint-variable-setting-intern ()
  (princ "\n\n")
  (princ "Some comint-mode variables of interest:\n\n")
  (princ (concat "comint-accum-marker" " --> " (prin1-to-string comint-accum-marker) "\n"))
  (princ (concat "comint-buffer-maximum-size" " --> " (prin1-to-string comint-buffer-maximum-size) "\n"))
  (princ (concat "comint-completion-addsuffix" " --> " (prin1-to-string comint-completion-addsuffix) "\n"))
  (princ (concat "comint-completion-autolist" " --> " (prin1-to-string comint-completion-autolist) "\n"))
  (princ (concat "comint-completion-fignore" " --> " (prin1-to-string comint-completion-fignore) "\n"))
  (princ (concat "comint-completion-recexact" " --> " (prin1-to-string comint-completion-recexact) "\n"))
  (princ (concat "comint-delimiter-argument-list" " --> " (prin1-to-string comint-delimiter-argument-list) "\n"))
  (princ (concat "comint-displayed-dynamic-completions" " --> " (prin1-to-string comint-displayed-dynamic-completions) "\n"))
  (princ (concat "comint-dynamic-complete-functions" " --> " (prin1-to-string comint-dynamic-complete-functions) "\n"))
  (princ (concat "comint-dynamic-list-completions-config" " --> " (prin1-to-string comint-dynamic-list-completions-config) "\n"))
  (princ (concat "comint-eol-on-send" " --> " (prin1-to-string comint-eol-on-send) "\n"))
  (princ (concat "comint-exec-hook" " --> " (prin1-to-string comint-exec-hook) "\n"))
  (princ (concat "comint-file-name-chars" " --> " (prin1-to-string comint-file-name-chars) "\n"))
  (princ (concat "comint-file-name-prefix" " --> " (prin1-to-string comint-file-name-prefix) "\n"))
  (princ (concat "comint-file-name-quote-list" " --> " (prin1-to-string comint-file-name-quote-list) "\n"))
  (princ (concat "comint-get-old-input" " --> " (prin1-to-string comint-get-old-input) "\n"))
  (princ (concat "comint-history-isearch" " --> " (prin1-to-string comint-history-isearch) "\n"))
  (princ (concat "comint-history-isearch-message-overlay" " --> " (prin1-to-string comint-history-isearch-message-overlay) "\n"))
  (princ (concat "comint-inhibit-carriage-motion" " --> " (prin1-to-string comint-inhibit-carriage-motion) "\n"))
  (princ (concat "comint-input-autoexpand" " --> " (prin1-to-string comint-input-autoexpand) "\n"))
  (princ (concat "comint-input-filter" " --> " (prin1-to-string comint-input-filter) "\n"))
  (princ (concat "comint-input-filter-functions" " --> " (prin1-to-string comint-input-filter-functions) "\n"))
  (princ (concat "comint-input-history-ignore" " --> " (prin1-to-string comint-input-history-ignore) "\n"))
  (princ (concat "comint-input-ignoredups" " --> " (prin1-to-string comint-input-ignoredups) "\n"))
  ;; (princ (concat "comint-input-ring" " --> " (prin1-to-string comint-input-ring) "\n"))
  (princ (concat "comint-input-ring-file-name" " --> " (prin1-to-string comint-input-ring-file-name) "\n"))
  (princ (concat "comint-input-ring-index" " --> " (prin1-to-string comint-input-ring-index) "\n"))
  (princ (concat "comint-input-ring-separator" " --> " (prin1-to-string comint-input-ring-separator) "\n"))
  (princ (concat "comint-input-ring-size" " --> " (prin1-to-string comint-input-ring-size) "\n"))
  (princ (concat "comint-input-sender" " --> " (prin1-to-string comint-input-sender) "\n"))
  (princ (concat "comint-input-sender-no-newline" " --> " (prin1-to-string comint-input-sender-no-newline) "\n"))
  (princ (concat "comint-insert-previous-argument-last-index" " --> " (prin1-to-string comint-insert-previous-argument-last-index) "\n"))
  (princ (concat "comint-insert-previous-argument-last-start-pos" " --> " (prin1-to-string comint-insert-previous-argument-last-start-pos) "\n"))
  (princ (concat "comint-last-input-end" " --> " (prin1-to-string comint-last-input-end) "\n"))
  (princ (concat "comint-last-input-start" " --> " (prin1-to-string comint-last-input-start) "\n"))
  (princ (concat "comint-last-output-start" " --> " (prin1-to-string comint-last-output-start) "\n"))
  (princ (concat "comint-last-prompt-overlay" " --> " (prin1-to-string comint-last-prompt-overlay) "\n"))
  (princ (concat "comint-matching-input-from-input-string" " --> " (prin1-to-string comint-matching-input-from-input-string) "\n"))
  ;; (princ (concat "comint-mode-abbrev-table" " --> " (prin1-to-string comint-mode-abbrev-table) "\n"))
  (princ (concat "comint-mode-hook" " --> " (prin1-to-string comint-mode-hook) "\n"))
  ;; (princ (concat "comint-mode-map" " --> " (prin1-to-string comint-mode-map) "\n"))
  ;; (princ (concat "comint-mode-syntax-table" " --> " (prin1-to-string comint-mode-syntax-table) "\n"))
  (princ (concat "comint-move-point-for-output" " --> " (prin1-to-string comint-move-point-for-output) "\n"))
  (princ (concat "comint-output-filter-functions" " --> " (prin1-to-string comint-output-filter-functions) "\n"))
  (princ (concat "comint-password-prompt-regexp" " --> " (prin1-to-string comint-password-prompt-regexp) "\n"))
  (princ (concat "comint-preoutput-filter-functions" " --> " (prin1-to-string comint-preoutput-filter-functions) "\n"))
  (princ (concat "comint-process-echoes" " --> " (prin1-to-string comint-process-echoes) "\n"))
  (princ (concat "comint-prompt-read-only" " --> " (prin1-to-string comint-prompt-read-only) "\n"))
  (princ (concat "comint-prompt-regexp" " --> " (prin1-to-string comint-prompt-regexp) "\n"))
  (princ (concat "comint-ptyp" " --> " (prin1-to-string comint-ptyp) "\n"))
  (princ (concat "comint-redirect-completed" " --> " (prin1-to-string comint-redirect-completed) "\n"))
  (princ (concat "comint-redirect-echo-input" " --> " (prin1-to-string comint-redirect-echo-input) "\n"))
  (princ (concat "comint-redirect-filter-functions" " --> " (prin1-to-string comint-redirect-filter-functions) "\n"))
  (princ (concat "comint-redirect-finished-regexp" " --> " (prin1-to-string comint-redirect-finished-regexp) "\n"))
  (princ (concat "comint-redirect-insert-matching-regexp" " --> " (prin1-to-string comint-redirect-insert-matching-regexp) "\n"))
  (princ (concat "comint-redirect-original-filter-function" " --> " (prin1-to-string comint-redirect-original-filter-function) "\n"))
  (princ (concat "comint-redirect-original-mode-line-process" " --> " (prin1-to-string comint-redirect-original-mode-line-process) "\n"))
  (princ (concat "comint-redirect-output-buffer" " --> " (prin1-to-string comint-redirect-output-buffer) "\n"))
  (princ (concat "comint-redirect-perform-sanity-check" " --> " (prin1-to-string comint-redirect-perform-sanity-check) "\n"))
  (princ (concat "comint-redirect-subvert-readonly" " --> " (prin1-to-string comint-redirect-subvert-readonly) "\n"))
  (princ (concat "comint-redirect-verbose" " --> " (prin1-to-string comint-redirect-verbose) "\n"))
  (princ (concat "comint-save-input-ring-index" " --> " (prin1-to-string comint-save-input-ring-index) "\n"))
  (princ (concat "comint-scroll-show-maximum-output" " --> " (prin1-to-string comint-scroll-show-maximum-output) "\n"))
  (princ (concat "comint-scroll-to-bottom-on-input" " --> " (prin1-to-string comint-scroll-to-bottom-on-input) "\n"))
  (princ (concat "comint-scroll-to-bottom-on-output" " --> " (prin1-to-string comint-scroll-to-bottom-on-output) "\n"))
  (princ (concat "comint-stored-incomplete-input" " --> " (prin1-to-string comint-stored-incomplete-input) "\n"))
  (princ (concat "comint-use-prompt-regexp" " --> " (prin1-to-string comint-use-prompt-regexp) "\n"))
  (princ (concat "comint-use-prompt-regexp-instead-of-fields" " --> " (prin1-to-string comint-use-prompt-regexp-instead-of-fields) "\n")))
