...
(setq python-mode-tests
      (if (featurep 'xemacs)
        ...
        (list
         ...
         'py-execute-clause-python-test
         'py-execute-clause-python-switch-test
         'py-execute-clause-python-noswitch-test
         'py-execute-clause-python-dedicated-test
         'py-execute-clause-python-dedicated-switch-test
         'py-execute-clause-ipython-test
         'py-execute-clause-ipython-switch-test
         'py-execute-clause-ipython-noswitch-test
         'py-execute-clause-ipython-dedicated-test
         'py-execute-clause-ipython-dedicated-switch-test
         'py-execute-clause-python3-test
         'py-execute-clause-python3-switch-test
         'py-execute-clause-python3-noswitch-test
         'py-execute-clause-python3-dedicated-test
         'py-execute-clause-python3-dedicated-switch-test
         'py-execute-clause-python2-test
         'py-execute-clause-python2-switch-test
         'py-execute-clause-python2-noswitch-test
         'py-execute-clause-python2-dedicated-test
         'py-execute-clause-python2-dedicated-switch-test
         'py-execute-clause-python2.7-test
         'py-execute-clause-python2.7-switch-test
         'py-execute-clause-python2.7-noswitch-test
         'py-execute-clause-python2.7-dedicated-test
         'py-execute-clause-python2.7-dedicated-switch-test
         'py-execute-clause-jython-test
         'py-execute-clause-jython-switch-test
         'py-execute-clause-jython-noswitch-test
         'py-execute-clause-jython-dedicated-test
         'py-execute-clause-jython-dedicated-switch-test
