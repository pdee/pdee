...
--funcall py-beginning-of-minor-expression-position-commandp-test \
--funcall py-end-of-minor-expression-position-commandp-test \
...
--funcall py-bounds-of-minor-expression-commandp-test \
...
--funcall py-beginning-of-minor-expression-p-commandp-test \
...
--funcall py-shell-command-on-region-commandp-test \
--funcall py-ipython-shell-command-on-region-commandp-test \
--funcall py-send-region-ipython-commandp-test \
--funcall ipython-send-and-indent-commandp-test \
--funcall py-execute-region-in-shell-commandp-test \
...
--funcall py-execute-minor-expression-python-commandp-test \
--funcall py-execute-minor-expression-python-switch-commandp-test \
--funcall py-execute-minor-expression-python-noswitch-commandp-test \
--funcall py-execute-minor-expression-python-dedicated-commandp-test \
--funcall py-execute-minor-expression-python-dedicated-switch-commandp-test \
--funcall py-execute-minor-expression-ipython-commandp-test \
--funcall py-execute-minor-expression-ipython-switch-commandp-test \
--funcall py-execute-minor-expression-ipython-noswitch-commandp-test \
--funcall py-execute-minor-expression-ipython-dedicated-commandp-test \
--funcall py-execute-minor-expression-ipython-dedicated-switch-commandp-test \
--funcall py-execute-minor-expression-python3-commandp-test \
--funcall py-execute-minor-expression-python3-switch-commandp-test \
--funcall py-execute-minor-expression-python3-noswitch-commandp-test \
--funcall py-execute-minor-expression-python3-dedicated-commandp-test \
--funcall py-execute-minor-expression-python3-dedicated-switch-commandp-test \
--funcall py-execute-minor-expression-python2-commandp-test \
--funcall py-execute-minor-expression-python2-switch-commandp-test \
--funcall py-execute-minor-expression-python2-noswitch-commandp-test \
--funcall py-execute-minor-expression-python2-dedicated-commandp-test \
--funcall py-execute-minor-expression-python2-dedicated-switch-commandp-test \
--funcall py-execute-minor-expression-python2.7-commandp-test \
--funcall py-execute-minor-expression-python2.7-switch-commandp-test \
--funcall py-execute-minor-expression-python2.7-noswitch-commandp-test \
--funcall py-execute-minor-expression-python2.7-dedicated-commandp-test \
--funcall py-execute-minor-expression-python2.7-dedicated-switch-commandp-test \
--funcall py-execute-minor-expression-jython-commandp-test \
--funcall py-execute-minor-expression-jython-switch-commandp-test \
--funcall py-execute-minor-expression-jython-noswitch-commandp-test \
--funcall py-execute-minor-expression-jython-dedicated-commandp-test \
--funcall py-execute-minor-expression-jython-dedicated-switch-commandp-test \
--funcall py-execute-minor-expression-python3.2-commandp-test \
--funcall py-execute-minor-expression-python3.2-switch-commandp-test \
