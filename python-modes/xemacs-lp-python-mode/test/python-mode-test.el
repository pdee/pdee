...
(defun py-beginning-of-minor-expression-position-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-beginning-of-minor-expression-position-commandp-base arg teststring)))

(defun py-beginning-of-minor-expression-position-commandp-base ()
  (assert (commandp 'py-beginning-of-minor-expression-position) nil "py-beginning-of-minor-expression-position-commandp-test failed"))

(defun py-end-of-minor-expression-position-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-end-of-minor-expression-position-commandp-base arg teststring)))

(defun py-end-of-minor-expression-position-commandp-base ()
  (assert (commandp 'py-end-of-minor-expression-position) nil "py-end-of-minor-expression-position-commandp-test failed"))
...
(defun py-bounds-of-minor-expression-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-bounds-of-minor-expression-commandp-base arg teststring)))

(defun py-bounds-of-minor-expression-commandp-base ()
  (assert (commandp 'py-bounds-of-minor-expression) nil "py-bounds-of-minor-expression-commandp-test failed"))
...
(defun py-beginning-of-minor-expression-p-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-beginning-of-minor-expression-p-commandp-base arg teststring)))

(defun py-beginning-of-minor-expression-p-commandp-base ()
  (assert (commandp 'py-beginning-of-minor-expression-p) nil "py-beginning-of-minor-expression-p-commandp-test failed"))
...
(defun py-mark-minor-expression-commandp-base ()
  (assert (commandp 'py-mark-minor-expression) nil "py-mark-minor-expression-commandp-test failed"))
...
(defun py-execute-clause-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-commandp-base arg teststring)))

(defun py-execute-clause-commandp-base ()
  (assert (commandp 'py-execute-clause) nil "py-execute-clause-commandp-test failed"))
...
(defun py-execute-clause-python-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python-commandp-base arg teststring)))

(defun py-execute-clause-python-commandp-base ()
  (assert (commandp 'py-execute-clause-python) nil "py-execute-clause-python-commandp-test failed"))

(defun py-execute-clause-python-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python-switch-commandp-base arg teststring)))

(defun py-execute-clause-python-switch-commandp-base ()
  (assert (commandp 'py-execute-clause-python-switch) nil "py-execute-clause-python-switch-commandp-test failed"))

(defun py-execute-clause-python-noswitch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python-noswitch-commandp-base arg teststring)))

(defun py-execute-clause-python-noswitch-commandp-base ()
  (assert (commandp 'py-execute-clause-python-noswitch) nil "py-execute-clause-python-noswitch-commandp-test failed"))

(defun py-execute-clause-python-dedicated-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python-dedicated-commandp-base arg teststring)))

(defun py-execute-clause-python-dedicated-commandp-base ()
  (assert (commandp 'py-execute-clause-python-dedicated) nil "py-execute-clause-python-dedicated-commandp-test failed"))

(defun py-execute-clause-python-dedicated-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python-dedicated-switch-commandp-base arg teststring)))

(defun py-execute-clause-python-dedicated-switch-commandp-base ()
  (assert (commandp 'py-execute-clause-python-dedicated-switch) nil "py-execute-clause-python-dedicated-switch-commandp-test failed"))

(defun py-execute-clause-ipython-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-ipython-commandp-base arg teststring)))

(defun py-execute-clause-ipython-commandp-base ()
  (assert (commandp 'py-execute-clause-ipython) nil "py-execute-clause-ipython-commandp-test failed"))

(defun py-execute-clause-ipython-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-ipython-switch-commandp-base arg teststring)))

(defun py-execute-clause-ipython-switch-commandp-base ()
  (assert (commandp 'py-execute-clause-ipython-switch) nil "py-execute-clause-ipython-switch-commandp-test failed"))

(defun py-execute-clause-ipython-noswitch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-ipython-noswitch-commandp-base arg teststring)))

(defun py-execute-clause-ipython-noswitch-commandp-base ()
  (assert (commandp 'py-execute-clause-ipython-noswitch) nil "py-execute-clause-ipython-noswitch-commandp-test failed"))

(defun py-execute-clause-ipython-dedicated-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-ipython-dedicated-commandp-base arg teststring)))

(defun py-execute-clause-ipython-dedicated-commandp-base ()
  (assert (commandp 'py-execute-clause-ipython-dedicated) nil "py-execute-clause-ipython-dedicated-commandp-test failed"))

(defun py-execute-clause-ipython-dedicated-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-ipython-dedicated-switch-commandp-base arg teststring)))

(defun py-execute-clause-ipython-dedicated-switch-commandp-base ()
  (assert (commandp 'py-execute-clause-ipython-dedicated-switch) nil "py-execute-clause-ipython-dedicated-switch-commandp-test failed"))

(defun py-execute-clause-python3-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python3-commandp-base arg teststring)))

(defun py-execute-clause-python3-commandp-base ()
  (assert (commandp 'py-execute-clause-python3) nil "py-execute-clause-python3-commandp-test failed"))

(defun py-execute-clause-python3-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python3-switch-commandp-base arg teststring)))

(defun py-execute-clause-python3-switch-commandp-base ()
  (assert (commandp 'py-execute-clause-python3-switch) nil "py-execute-clause-python3-switch-commandp-test failed"))

(defun py-execute-clause-python3-noswitch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python3-noswitch-commandp-base arg teststring)))

(defun py-execute-clause-python3-noswitch-commandp-base ()
  (assert (commandp 'py-execute-clause-python3-noswitch) nil "py-execute-clause-python3-noswitch-commandp-test failed"))

(defun py-execute-clause-python3-dedicated-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python3-dedicated-commandp-base arg teststring)))

(defun py-execute-clause-python3-dedicated-commandp-base ()
  (assert (commandp 'py-execute-clause-python3-dedicated) nil "py-execute-clause-python3-dedicated-commandp-test failed"))

(defun py-execute-clause-python3-dedicated-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python3-dedicated-switch-commandp-base arg teststring)))

(defun py-execute-clause-python3-dedicated-switch-commandp-base ()
  (assert (commandp 'py-execute-clause-python3-dedicated-switch) nil "py-execute-clause-python3-dedicated-switch-commandp-test failed"))

(defun py-execute-clause-python2-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python2-commandp-base arg teststring)))

(defun py-execute-clause-python2-commandp-base ()
  (assert (commandp 'py-execute-clause-python2) nil "py-execute-clause-python2-commandp-test failed"))

(defun py-execute-clause-python2-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python2-switch-commandp-base arg teststring)))

(defun py-execute-clause-python2-switch-commandp-base ()
  (assert (commandp 'py-execute-clause-python2-switch) nil "py-execute-clause-python2-switch-commandp-test failed"))

(defun py-execute-clause-python2-noswitch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python2-noswitch-commandp-base arg teststring)))

(defun py-execute-clause-python2-noswitch-commandp-base ()
  (assert (commandp 'py-execute-clause-python2-noswitch) nil "py-execute-clause-python2-noswitch-commandp-test failed"))

(defun py-execute-clause-python2-dedicated-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python2-dedicated-commandp-base arg teststring)))

(defun py-execute-clause-python2-dedicated-commandp-base ()
  (assert (commandp 'py-execute-clause-python2-dedicated) nil "py-execute-clause-python2-dedicated-commandp-test failed"))

(defun py-execute-clause-python2-dedicated-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python2-dedicated-switch-commandp-base arg teststring)))

(defun py-execute-clause-python2-dedicated-switch-commandp-base ()
  (assert (commandp 'py-execute-clause-python2-dedicated-switch) nil "py-execute-clause-python2-dedicated-switch-commandp-test failed"))

(defun py-execute-clause-python2.7-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python2.7-commandp-base arg teststring)))

(defun py-execute-clause-python2.7-commandp-base ()
  (assert (commandp 'py-execute-clause-python2.7) nil "py-execute-clause-python2.7-commandp-test failed"))

(defun py-execute-clause-python2.7-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python2.7-switch-commandp-base arg teststring)))

(defun py-execute-clause-python2.7-switch-commandp-base ()
  (assert (commandp 'py-execute-clause-python2.7-switch) nil "py-execute-clause-python2.7-switch-commandp-test failed"))

(defun py-execute-clause-python2.7-noswitch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python2.7-noswitch-commandp-base arg teststring)))

(defun py-execute-clause-python2.7-noswitch-commandp-base ()
  (assert (commandp 'py-execute-clause-python2.7-noswitch) nil "py-execute-clause-python2.7-noswitch-commandp-test failed"))

(defun py-execute-clause-python2.7-dedicated-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python2.7-dedicated-commandp-base arg teststring)))

(defun py-execute-clause-python2.7-dedicated-commandp-base ()
  (assert (commandp 'py-execute-clause-python2.7-dedicated) nil "py-execute-clause-python2.7-dedicated-commandp-test failed"))

(defun py-execute-clause-python2.7-dedicated-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python2.7-dedicated-switch-commandp-base arg teststring)))

(defun py-execute-clause-python2.7-dedicated-switch-commandp-base ()
  (assert (commandp 'py-execute-clause-python2.7-dedicated-switch) nil "py-execute-clause-python2.7-dedicated-switch-commandp-test failed"))

(defun py-execute-clause-jython-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-jython-commandp-base arg teststring)))

(defun py-execute-clause-jython-commandp-base ()
  (assert (commandp 'py-execute-clause-jython) nil "py-execute-clause-jython-commandp-test failed"))

(defun py-execute-clause-jython-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-jython-switch-commandp-base arg teststring)))

(defun py-execute-clause-jython-switch-commandp-base ()
  (assert (commandp 'py-execute-clause-jython-switch) nil "py-execute-clause-jython-switch-commandp-test failed"))

(defun py-execute-clause-jython-noswitch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-jython-noswitch-commandp-base arg teststring)))

(defun py-execute-clause-jython-noswitch-commandp-base ()
  (assert (commandp 'py-execute-clause-jython-noswitch) nil "py-execute-clause-jython-noswitch-commandp-test failed"))

(defun py-execute-clause-jython-dedicated-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-jython-dedicated-commandp-base arg teststring)))

(defun py-execute-clause-jython-dedicated-commandp-base ()
  (assert (commandp 'py-execute-clause-jython-dedicated) nil "py-execute-clause-jython-dedicated-commandp-test failed"))

(defun py-execute-clause-jython-dedicated-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-jython-dedicated-switch-commandp-base arg teststring)))

(defun py-execute-clause-jython-dedicated-switch-commandp-base ()
  (assert (commandp 'py-execute-clause-jython-dedicated-switch) nil "py-execute-clause-jython-dedicated-switch-commandp-test failed"))

(defun py-execute-clause-python3.2-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python3.2-commandp-base arg teststring)))

(defun py-execute-clause-python3.2-commandp-base ()
  (assert (commandp 'py-execute-clause-python3.2) nil "py-execute-clause-python3.2-commandp-test failed"))

(defun py-execute-clause-python3.2-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python3.2-switch-commandp-base arg teststring)))

(defun py-execute-clause-python3.2-switch-commandp-base ()
  (assert (commandp 'py-execute-clause-python3.2-switch) nil "py-execute-clause-python3.2-switch-commandp-test failed"))

(defun py-execute-clause-python3.2-noswitch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python3.2-noswitch-commandp-base arg teststring)))

(defun py-execute-clause-python3.2-noswitch-commandp-base ()
  (assert (commandp 'py-execute-clause-python3.2-noswitch) nil "py-execute-clause-python3.2-noswitch-commandp-test failed"))

(defun py-execute-clause-python3.2-dedicated-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python3.2-dedicated-commandp-base arg teststring)))

(defun py-execute-clause-python3.2-dedicated-commandp-base ()
  (assert (commandp 'py-execute-clause-python3.2-dedicated) nil "py-execute-clause-python3.2-dedicated-commandp-test failed"))

(defun py-execute-clause-python3.2-dedicated-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-clause-python3.2-dedicated-switch-commandp-base arg teststring)))

(defun py-execute-clause-python3.2-dedicated-switch-commandp-base ()
  (assert (commandp 'py-execute-clause-python3.2-dedicated-switch) nil "py-execute-clause-python3.2-dedicated-switch-commandp-test failed"))
...
(defun py-execute-minor-expression-python-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python-commandp-base arg teststring)))

(defun py-execute-minor-expression-python-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python) nil "py-execute-minor-expression-python-commandp-test failed"))

(defun py-execute-minor-expression-python-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python-switch-commandp-base arg teststring)))

(defun py-execute-minor-expression-python-switch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python-switch) nil "py-execute-minor-expression-python-switch-commandp-test failed"))

(defun py-execute-minor-expression-python-noswitch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python-noswitch-commandp-base arg teststring)))

(defun py-execute-minor-expression-python-noswitch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python-noswitch) nil "py-execute-minor-expression-python-noswitch-commandp-test failed"))

(defun py-execute-minor-expression-python-dedicated-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python-dedicated-commandp-base arg teststring)))

(defun py-execute-minor-expression-python-dedicated-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python-dedicated) nil "py-execute-minor-expression-python-dedicated-commandp-test failed"))

(defun py-execute-minor-expression-python-dedicated-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python-dedicated-switch-commandp-base arg teststring)))

(defun py-execute-minor-expression-python-dedicated-switch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python-dedicated-switch) nil "py-execute-minor-expression-python-dedicated-switch-commandp-test failed"))

(defun py-execute-minor-expression-ipython-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-ipython-commandp-base arg teststring)))

(defun py-execute-minor-expression-ipython-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-ipython) nil "py-execute-minor-expression-ipython-commandp-test failed"))

(defun py-execute-minor-expression-ipython-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-ipython-switch-commandp-base arg teststring)))

(defun py-execute-minor-expression-ipython-switch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-ipython-switch) nil "py-execute-minor-expression-ipython-switch-commandp-test failed"))

(defun py-execute-minor-expression-ipython-noswitch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-ipython-noswitch-commandp-base arg teststring)))

(defun py-execute-minor-expression-ipython-noswitch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-ipython-noswitch) nil "py-execute-minor-expression-ipython-noswitch-commandp-test failed"))

(defun py-execute-minor-expression-ipython-dedicated-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-ipython-dedicated-commandp-base arg teststring)))

(defun py-execute-minor-expression-ipython-dedicated-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-ipython-dedicated) nil "py-execute-minor-expression-ipython-dedicated-commandp-test failed"))

(defun py-execute-minor-expression-ipython-dedicated-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-ipython-dedicated-switch-commandp-base arg teststring)))

(defun py-execute-minor-expression-ipython-dedicated-switch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-ipython-dedicated-switch) nil "py-execute-minor-expression-ipython-dedicated-switch-commandp-test failed"))

(defun py-execute-minor-expression-python3-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python3-commandp-base arg teststring)))

(defun py-execute-minor-expression-python3-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python3) nil "py-execute-minor-expression-python3-commandp-test failed"))

(defun py-execute-minor-expression-python3-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python3-switch-commandp-base arg teststring)))

(defun py-execute-minor-expression-python3-switch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python3-switch) nil "py-execute-minor-expression-python3-switch-commandp-test failed"))

(defun py-execute-minor-expression-python3-noswitch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python3-noswitch-commandp-base arg teststring)))

(defun py-execute-minor-expression-python3-noswitch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python3-noswitch) nil "py-execute-minor-expression-python3-noswitch-commandp-test failed"))

(defun py-execute-minor-expression-python3-dedicated-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python3-dedicated-commandp-base arg teststring)))

(defun py-execute-minor-expression-python3-dedicated-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python3-dedicated) nil "py-execute-minor-expression-python3-dedicated-commandp-test failed"))

(defun py-execute-minor-expression-python3-dedicated-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python3-dedicated-switch-commandp-base arg teststring)))

(defun py-execute-minor-expression-python3-dedicated-switch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python3-dedicated-switch) nil "py-execute-minor-expression-python3-dedicated-switch-commandp-test failed"))

(defun py-execute-minor-expression-python2-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python2-commandp-base arg teststring)))

(defun py-execute-minor-expression-python2-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python2) nil "py-execute-minor-expression-python2-commandp-test failed"))

(defun py-execute-minor-expression-python2-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python2-switch-commandp-base arg teststring)))

(defun py-execute-minor-expression-python2-switch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python2-switch) nil "py-execute-minor-expression-python2-switch-commandp-test failed"))

(defun py-execute-minor-expression-python2-noswitch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python2-noswitch-commandp-base arg teststring)))

(defun py-execute-minor-expression-python2-noswitch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python2-noswitch) nil "py-execute-minor-expression-python2-noswitch-commandp-test failed"))

(defun py-execute-minor-expression-python2-dedicated-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python2-dedicated-commandp-base arg teststring)))

(defun py-execute-minor-expression-python2-dedicated-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python2-dedicated) nil "py-execute-minor-expression-python2-dedicated-commandp-test failed"))

(defun py-execute-minor-expression-python2-dedicated-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python2-dedicated-switch-commandp-base arg teststring)))

(defun py-execute-minor-expression-python2-dedicated-switch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python2-dedicated-switch) nil "py-execute-minor-expression-python2-dedicated-switch-commandp-test failed"))

(defun py-execute-minor-expression-python2.7-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python2.7-commandp-base arg teststring)))

(defun py-execute-minor-expression-python2.7-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python2.7) nil "py-execute-minor-expression-python2.7-commandp-test failed"))

(defun py-execute-minor-expression-python2.7-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python2.7-switch-commandp-base arg teststring)))

(defun py-execute-minor-expression-python2.7-switch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python2.7-switch) nil "py-execute-minor-expression-python2.7-switch-commandp-test failed"))

(defun py-execute-minor-expression-python2.7-noswitch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python2.7-noswitch-commandp-base arg teststring)))

(defun py-execute-minor-expression-python2.7-noswitch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python2.7-noswitch) nil "py-execute-minor-expression-python2.7-noswitch-commandp-test failed"))

(defun py-execute-minor-expression-python2.7-dedicated-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python2.7-dedicated-commandp-base arg teststring)))

(defun py-execute-minor-expression-python2.7-dedicated-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python2.7-dedicated) nil "py-execute-minor-expression-python2.7-dedicated-commandp-test failed"))

(defun py-execute-minor-expression-python2.7-dedicated-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python2.7-dedicated-switch-commandp-base arg teststring)))

(defun py-execute-minor-expression-python2.7-dedicated-switch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python2.7-dedicated-switch) nil "py-execute-minor-expression-python2.7-dedicated-switch-commandp-test failed"))

(defun py-execute-minor-expression-jython-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-jython-commandp-base arg teststring)))

(defun py-execute-minor-expression-jython-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-jython) nil "py-execute-minor-expression-jython-commandp-test failed"))

(defun py-execute-minor-expression-jython-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-jython-switch-commandp-base arg teststring)))

(defun py-execute-minor-expression-jython-switch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-jython-switch) nil "py-execute-minor-expression-jython-switch-commandp-test failed"))

(defun py-execute-minor-expression-jython-noswitch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-jython-noswitch-commandp-base arg teststring)))

(defun py-execute-minor-expression-jython-noswitch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-jython-noswitch) nil "py-execute-minor-expression-jython-noswitch-commandp-test failed"))

(defun py-execute-minor-expression-jython-dedicated-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-jython-dedicated-commandp-base arg teststring)))

(defun py-execute-minor-expression-jython-dedicated-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-jython-dedicated) nil "py-execute-minor-expression-jython-dedicated-commandp-test failed"))

(defun py-execute-minor-expression-jython-dedicated-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-jython-dedicated-switch-commandp-base arg teststring)))

(defun py-execute-minor-expression-jython-dedicated-switch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-jython-dedicated-switch) nil "py-execute-minor-expression-jython-dedicated-switch-commandp-test failed"))

(defun py-execute-minor-expression-python3.2-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python3.2-commandp-base arg teststring)))

(defun py-execute-minor-expression-python3.2-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python3.2) nil "py-execute-minor-expression-python3.2-commandp-test failed"))

(defun py-execute-minor-expression-python3.2-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python3.2-switch-commandp-base arg teststring)))

(defun py-execute-minor-expression-python3.2-switch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python3.2-switch) nil "py-execute-minor-expression-python3.2-switch-commandp-test failed"))

(defun py-execute-minor-expression-python3.2-noswitch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python3.2-noswitch-commandp-base arg teststring)))

(defun py-execute-minor-expression-python3.2-noswitch-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python3.2-noswitch) nil "py-execute-minor-expression-python3.2-noswitch-commandp-test failed"))

(defun py-execute-minor-expression-python3.2-dedicated-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python3.2-dedicated-commandp-base arg teststring)))

(defun py-execute-minor-expression-python3.2-dedicated-commandp-base ()
  (assert (commandp 'py-execute-minor-expression-python3.2-dedicated) nil "py-execute-minor-expression-python3.2-dedicated-commandp-test failed"))

(defun py-execute-minor-expression-python3.2-dedicated-switch-commandp-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring ""))
    (when load-branch-function (funcall load-branch-function))
    (py-bug-tests-intern 'py-execute-minor-expression-python3.2-dedicated-switch-commandp-base arg teststring)))
