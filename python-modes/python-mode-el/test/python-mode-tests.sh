...
--funcall py-execute-statement-jython-test \
--funcall py-execute-statement-jython-switch-test \
--funcall py-execute-statement-jython-noswitch-test \
--funcall py-execute-statement-jython-dedicated-test \
--funcall py-execute-statement-jython-dedicated-switch-test \
...
--funcall py-execute-block-jython-test \
--funcall py-execute-block-jython-switch-test \
--funcall py-execute-block-jython-noswitch-test \
--funcall py-execute-block-jython-dedicated-test \
--funcall py-execute-block-jython-dedicated-switch-test \
--funcall py-execute-clause-python-test \
--funcall py-execute-clause-python-switch-test \
--funcall py-execute-clause-python-noswitch-test \
--funcall py-execute-clause-python-dedicated-test \
--funcall py-execute-clause-python-dedicated-switch-test \
--funcall py-execute-clause-ipython-test \
--funcall py-execute-clause-ipython-switch-test \
--funcall py-execute-clause-ipython-noswitch-test \
--funcall py-execute-clause-ipython-dedicated-test \
--funcall py-execute-clause-ipython-dedicated-switch-test \
--funcall py-execute-clause-python3-test \
--funcall py-execute-clause-python3-switch-test \
--funcall py-execute-clause-python3-noswitch-test \
--funcall py-execute-clause-python3-dedicated-test \
--funcall py-execute-clause-python3-dedicated-switch-test \
--funcall py-execute-clause-python2-test \
--funcall py-execute-clause-python2-switch-test \
--funcall py-execute-clause-python2-noswitch-test \
--funcall py-execute-clause-python2-dedicated-test \
--funcall py-execute-clause-python2-dedicated-switch-test \
--funcall py-execute-clause-python2.7-test \
--funcall py-execute-clause-python2.7-switch-test \
--funcall py-execute-clause-python2.7-noswitch-test \
--funcall py-execute-clause-python2.7-dedicated-test \
--funcall py-execute-clause-python2.7-dedicated-switch-test \
--funcall py-execute-clause-jython-test \
--funcall py-execute-clause-jython-switch-test \
--funcall py-execute-clause-jython-noswitch-test \
--funcall py-execute-clause-jython-dedicated-test \
--funcall py-execute-clause-jython-dedicated-switch-test \
...
--funcall py-execute-block-or-clause-jython-test \
--funcall py-execute-block-or-clause-jython-switch-test \
--funcall py-execute-block-or-clause-jython-noswitch-test \
--funcall py-execute-block-or-clause-jython-dedicated-test \
--funcall py-execute-block-or-clause-jython-dedicated-switch-test \
...
--funcall py-execute-def-jython-test \
--funcall py-execute-def-jython-switch-test \
--funcall py-execute-def-jython-noswitch-test \
--funcall py-execute-def-jython-dedicated-test \
--funcall py-execute-def-jython-dedicated-switch-test \
...
--funcall py-execute-class-jython-test \
--funcall py-execute-class-jython-switch-test \
--funcall py-execute-class-jython-noswitch-test \
--funcall py-execute-class-jython-dedicated-test \
--funcall py-execute-class-jython-dedicated-switch-test \
...
--funcall py-execute-region-jython-test \
--funcall py-execute-region-jython-switch-test \
--funcall py-execute-region-jython-noswitch-test \
--funcall py-execute-region-jython-dedicated-test \
--funcall py-execute-region-jython-dedicated-switch-test \
...
--funcall py-execute-buffer-jython-test \
--funcall py-execute-buffer-jython-switch-test \
--funcall py-execute-buffer-jython-noswitch-test \
--funcall py-execute-buffer-jython-dedicated-test \
--funcall py-execute-buffer-jython-dedicated-switch-test \
...
--funcall py-execute-expression-jython-test \
--funcall py-execute-expression-jython-switch-test \
--funcall py-execute-expression-jython-noswitch-test \
--funcall py-execute-expression-jython-dedicated-test \
--funcall py-execute-expression-jython-dedicated-switch-test \
...
--funcall py-execute-partial-expression-jython-test \
--funcall py-execute-partial-expression-jython-switch-test \
--funcall py-execute-partial-expression-jython-noswitch-test \
--funcall py-execute-partial-expression-jython-dedicated-test \
--funcall py-execute-partial-expression-jython-dedicated-switch-test \
...
--funcall py-execute-line-jython-test \
--funcall py-execute-line-jython-switch-test \
--funcall py-execute-line-jython-noswitch-test \
--funcall py-execute-line-jython-dedicated-test \
--funcall py-execute-line-jython-dedicated-switch-test \
