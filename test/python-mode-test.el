...
(defun py-end-of-expression-base ()
  ...
  (assert (eq 165 (py-end-of-expression)) nil "py-end-of-expression-test failed")
  (assert (eq 176 (py-end-of-expression)) nil "py-end-of-expression-test failed")
  (assert (eq 196 (py-end-of-expression)) nil "py-end-of-expression-test failed")
  (assert (eq 212 (py-end-of-expression)) nil "py-end-of-expression-test failed")
