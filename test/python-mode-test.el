...
(defun UnicodeEncodeError-python3-test (&optional arg load-branch-function)
  (interactive "p")
  (let ((teststring (concat "# -\*- coding: utf-8 -\*-\n
print(\'\\xA9\')
")))
...
(defun py-fill-string-onetwo-base (arg)
  ...
  (forward-line 1)
  (assert (py-empty-line-p) nil "py-fill-string-onetwo-test #1 failed")
  (message "%s" "py-fill-string-onetwo-test #1  passed")
  (forward-line 2)
  (assert (py-empty-line-p) nil "py-fill-string-onetwo-test #2 failed")
...
(defun py-fill-string-pep-257-base (arg)
  ...
  (assert (py-empty-line-p) nil "py-fill-string-pep-257-test #2 failed")
  (message "%s" "py-fill-string-pep-257-test #2 passed")
  (forward-line 2)
  (assert (py-empty-line-p) nil "py-fill-string-pep-257-test #3 failed")
...
(defun py-fill-string-pep-257-nn-base (arg)
  ...
  (forward-line -1)
  (assert (not (py-empty-line-p))  nil "py-fill-string-pep-257-non-nil-test #2 failed"))
...
(defun py-fill-string-symmetric-base (arg)
  ...
  ;; (sit-for 0.1)
  (forward-line -4)
  (assert (py-empty-line-p) nil "py-fill-string-symmetric-test failed")
