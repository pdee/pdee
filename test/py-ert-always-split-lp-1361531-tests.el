...
print(\"I'm the py-always-split-dedicated-lp-1361531-python-test\")"
    ...
    (let* ((py-split-window-on-execute 'always)
      ...
      (assert (< 2 (count-windows)) nil \"py-always-split-dedicated-lp-1361531-python-test failed\")
...
print(\"I'm the py-always-split-dedicated-lp-1361531-ipython-test\")"
    ...
    (let* ((py-split-window-on-execute 'always)
      ...
      (sit-for 1 t)
      (when py-debug-p (message "(count-windows) %s" (count-windows)))
      (assert (< 2 (count-windows)) nil \"py-always-split-dedicated-lp-1361531-ipython-test failed\")
      (py-kill-buffer-unconditional erg1)
      (py-kill-buffer-unconditional erg2)
      (py-restore-window-configuration))))
...
print(\"I'm the py-always-split-dedicated-lp-1361531-python2-test\")"
    ...
    (let* ((py-split-window-on-execute 'always)
      ...
      (sit-for 1 t)
      (when py-debug-p (message "(count-windows) %s" (count-windows)))
      (assert (< 2 (count-windows)) nil \"py-always-split-dedicated-lp-1361531-python2-test failed\")
      (py-kill-buffer-unconditional erg1)
      (py-kill-buffer-unconditional erg2)
      (py-restore-window-configuration))))
...
print(\"I'm the py-always-split-dedicated-lp-1361531-jython-test\")"
    ...
    (let* ((py-split-window-on-execute 'always)
      ...
      (sit-for 1 t)
      (when py-debug-p (message "(count-windows) %s" (count-windows)))
      (assert (< 2 (count-windows)) nil \"py-always-split-dedicated-lp-1361531-jython-test failed\")
      (py-kill-buffer-unconditional erg1)
      (py-kill-buffer-unconditional erg2)
      (py-restore-window-configuration))))
...
print(\"I'm the py-always-split-dedicated-lp-1361531-python3-test\")"
    ...
    (let* ((py-split-window-on-execute 'always)
      ...
      (sit-for 1 t)
      (when py-debug-p (message "(count-windows) %s" (count-windows)))
      (assert (< 2 (count-windows)) nil \"py-always-split-dedicated-lp-1361531-python3-test failed\")
      (py-kill-buffer-unconditional erg1)
      (py-kill-buffer-unconditional erg2)
      (py-restore-window-configuration))))
