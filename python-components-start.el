	...
	((ignore-errors (string-match "python-mode" (py--buffer-filename-remote-maybe)))
	 (file-name-directory (py--buffer-filename-remote-maybe)))
        (t (if
	     ...
	     (if
		 (and (get-buffer "python-components-start.el")
		      (set-buffer (get-buffer "python-components-start.el"))
		      (buffer-file-name (get-buffer  "python-components-start.el")))
		 (setq py-install-directory (file-name-directory (buffer-file-name (get-buffer  "python-components-start.el"))))))
	   )))
